...
DATA_EVENT [ vdvLight ]
{
    ONLINE:
    {
	SEND_COMMAND vdvLight, "'REGISTER_CHANNEL-channel=1&label=Students'"
	SEND_COMMAND vdvLight, "'REGISTER_CHANNEL-channel=2&label=Front Left'"
	SEND_COMMAND vdvLight, "'REGISTER_CHANNEL-channel=4&label=Front Right'"
    }
}
...
DATA_EVENT [ vdvSystem ]
{
	...
	SEND_COMMAND vdvSystem,"'DEVICES_Add-',
				'name=SmartBoard Projector', 	//Name to show
				'&man=NEC',			
				'&model=NP-U310WG',
				'&sn=',
				'&ip=10.49.107.12', //Change IP
				'&devd=33011',
				'&devp=1',
				'&devs=0',
