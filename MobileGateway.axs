...
vdvRMSEngine4	= 33104:1:0
vdvRMSEngine5	= 33105:1:0

vdvCLActions1 	= 33201:1:0
vdvCLActions2 	= 33202:1:0
vdvCLActions3 	= 33203:1:0
vdvCLActions4	= 33204:1:0
vdvCLActions5	= 33205:1:0

vdvLesson1 	= 33301:1:0
vdvLesson2 	= 33302:1:0
vdvLesson3 	= 33303:1:0
vdvLesson4	= 33304:1:0
vdvLesson5	= 33305:1:0*/
...
//Define RMS Modules Mobile 1__________________________________________________
...
//Define RMS Modules Mobile 2__________________________________________________
...
//Define RMS Modules Mobile 3__________________________________________________
...
//Define RMS Modules Mobile 4__________________________________________________


DEFINE_MODULE 'i!-ConnectLinxEngineMod' mdlCL3(vdvCLActions4)
DEFINE_MODULE 'RMSEngineMod' mdlRMSEng3(vdvRMSEngine4, dvRMSSocket4, vdvCLActions4)

// RMSUIMod - The RMS User Interface.  Requires KeyboardMod.
// Channel And Variable Text Code Defined Inside The Module
DEFINE_MODULE 'RMSUIMod' mdlRMSUI(vdvRMSEngine4,
				  vdvLesson4,
                                  dvRMSTP,dvRMSTP_Base,
				  dvRMSTPWelcome,
				  dvRMSTPWelcome_Base,
...
//Define RMS Modules Mobile 5__________________________________________________


DEFINE_MODULE 'i!-ConnectLinxEngineMod' mdlCL3(vdvCLActions5)
DEFINE_MODULE 'RMSEngineMod' mdlRMSEng3(vdvRMSEngine5, dvRMSSocket5, vdvCLActions5)

// RMSUIMod - The RMS User Interface.  Requires KeyboardMod.
// Channel And Variable Text Code Defined Inside The Module
DEFINE_MODULE 'RMSUIMod' mdlRMSUI(vdvRMSEngine5,
				  vdvLesson5,
                                  dvRMSTP,dvRMSTP_Base,
				  dvRMSTPWelcome,
				  dvRMSTPWelcome_Base,
